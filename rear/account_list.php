				...
				<div class="table-scrollable">
					...
					<thead>
						<tr>
							...
							<th class="center"> Driver email</th>
					...
					<tbody>
						<?php 
						$s = $obj->generalSelectStatement(sel.drva);$res = $s->_general_result; 
						if (!empty($res)) {
							$num = 1;
							foreach ($res as $key => $value) {
								$d = $obj->generalSelectStatement(sel.drv." where id = ".$value->driver_id);$drv = $d->_general_result[0]; 
								?>
								<tr class="odd gradeX">
									<td class="center"><?=$num?></td>
									<td class="center"><?=$drv->email?></td>
									<td class="center"><?=$drv->firstname?> <?=$drv->lastname?></td>
									<td class="center"><?=$value->bank_account_no?></td>
									<td class="center"><?=$value->acctype?></td>
									<td class="center"><?=$value->rave_acc_id?></td>
									<td class="center">
										<a href="edit_accounts.php?id=<?=$value->id?>" class="btn btn-tbl-edit btn-xs">
											<i class="fa fa-pencil"></i>
										</a>
										<a class="btn btn-tbl-delete btn-xs" onclick="deleteInfo('accounts','<?=$value->id?>','id')">
