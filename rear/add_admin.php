	...
	<div class="page-content">
		...
		<div class="row">
			...
			<form id="addAdmin">
				<div class="card-body row">
					<div class="col-lg-12 col-md-12 col-sm-12 p-t-20">
						...
						tabIndex="-1" name="level">
						<label for="vtype" class="pull-right margin-0">
							<i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
						</label>
						<label for="vtype" class="mdl-textfield__label">Access Level</label>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 p-t-20">
				...
				id="adminPass" name="adminPass">
				<label class="mdl-textfield__label" for="adminPass">Password
				</label>
