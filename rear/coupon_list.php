				...
				<div class="table-scrollable">
					...
					<thead>
						<tr>
							...
							<th class="center"> Expirey Date </th>
					...
					<tbody>
						<?php $query = "select * from ".cpn; $q=$obj->generalSelectStatement($query); $res = $q->_general_result;
						if (!empty($res)) {
							$sn = 1; 
							foreach ($res as $key => $value) {
								$stat = $value->status == 'active'?'success':'danger';
								?>
								<tr class="odd gradeX">
									<td class="center"><?=$sn?></td>
									<td class="center"><?=$value->coupon?></td>
									<td class="center"><?=$value->start_date?></td>
									<td class="center"><?=$value->expire?></td>
									<td class="center"><?=$value->amount?></td>
									<td class="center"><?=$value->coupon_num?></td>
									<td class="center"><?=$value->coupon_used?></td>
									<td>
										<span
										class="label label-sm box-shadow-1 label-<?=$stat?>"><?=$value->status?></span>
									</td>
									<td class="center">
										<a href="edit_coupon.php?id=<?=$value->id?>" class="btn btn-tbl-edit btn-xs" >
											<i class="fa fa-pencil"></i>
										</a>
										<a class="btn btn-tbl-delete btn-xs" onclick="deleteInfo('coupons','<?=$value->id?>','id')">
